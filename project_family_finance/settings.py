"""
Django settings for project_family_finance project.
...
ROOT_URLCONF = 'project_family_finance.urls'
...
WSGI_APPLICATION = 'project_family_finance.wsgi.application'
